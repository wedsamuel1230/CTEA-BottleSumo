...
constexpr unsigned long TOF_POST_RESET_DELAY_MS = 20;
...
namespace Config {
  ...
  constexpr unsigned long DATA_FRESHNESS_TOLERANCE_MS = 60;
...
struct ToFReadings {
  ...
  String getDirection(uint16_t detection_threshold = DETECTION_THRESHOLD_MM) const {
    String direction;
